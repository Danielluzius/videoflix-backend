...
from video_app.api.views import VideoListView, VideoUploadView, HLSMasterView, HLSPlaylistView, HLSSegmentView

urlpatterns = [
    path('video/', VideoListView.as_view(), name='video-list'),
    path('video/upload/', VideoUploadView.as_view(), name='video-upload'),
    path('video/<int:video_id>/master.m3u8', HLSMasterView.as_view(), name='hls-master'),
